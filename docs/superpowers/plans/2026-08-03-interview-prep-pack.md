...
**Goal:** Create a disposable, four-hour interview preparation pack tailored to the 2026-08-04 full-stack interview.

**Architecture:** Keep every deliverable inside one repository-root temporary directory. Separate orientation, project evidence, technical answers, rehearsal, and final checks into focused Markdown files; link to existing knowledge-base articles instead of duplicating long tutorials.

**Tech Stack:** Markdown, repository-relative links, shell-based structural and link validation.

## Global Constraints

- Output directory: `临时-2026-08-04-面试冲刺/` at the repository root.
...
**Files:**
- Create: `临时-2026-08-04-面试冲刺/00-先看这里.md`
- Create: `临时-2026-08-04-面试冲刺/01-岗位画像与应对策略.md`
- Create: `临时-2026-08-04-面试冲刺/02-自我介绍.md`
...
```bash
test -s '临时-2026-08-04-面试冲刺/00-先看这里.md'
test -s '临时-2026-08-04-面试冲刺/01-岗位画像与应对策略.md'
test -s '临时-2026-08-04-面试冲刺/02-自我介绍.md'
```
...
**Files:**
- Create: `临时-2026-08-04-面试冲刺/03-NestJS采集项目主线.md`
- Create: `临时-2026-08-04-面试冲刺/04-前端项目备选故事.md`
- Create: `临时-2026-08-04-面试冲刺/06-短板与高压问题.md`
...
```bash
rg -n '【需本人确认】|MongoDB|Java|Koa|全栈|8 年' '临时-2026-08-04-面试冲刺/'
```
...
**Files:**
- Create: `临时-2026-08-04-面试冲刺/05-核心技术速答.md`
- Create: `临时-2026-08-04-面试冲刺/09-知识库最短索引.md`
...
Group links into “must read”, “read only if stuck”, and “skip tomorrow”. Use paths that resolve from `临时-2026-08-04-面试冲刺/` to existing repository files.

- [ ] **Step 3: Validate local Markdown links**

Run a small read-only Python script that extracts non-HTTP Markdown links from all temporary Markdown files, strips anchors, URL-decodes paths, resolves them relative to each source file, and fails if any target does not exist.
...
**Files:**
- Create: `临时-2026-08-04-面试冲刺/07-模拟面试.md`
- Create: `临时-2026-08-04-面试冲刺/08-反问薪资与检查清单.md`
- Create: `临时-2026-08-04-面试冲刺/练习记录.md`
...
- [ ] **Step 4: Verify the complete pack**

Run:

```bash
find '临时-2026-08-04-面试冲刺' -maxdepth 1 -type f -name '*.md' | sort
rg -n '待补全文|未完成答案|临时占位符' '临时-2026-08-04-面试冲刺' || true
git diff --check
git status --short
```

Expected: exactly 11 Markdown files; no accidental placeholder tokens; no whitespace errors; only the intended temporary directory plus pre-existing user changes remain uncommitted.
